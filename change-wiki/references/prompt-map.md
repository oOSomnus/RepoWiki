...
| overview_module | module_name, repo_structure | few_shot_examples, architecture_context, custom_instructions |
| overview_repo | repo_name, repo_structure | artifact_index, few_shot_examples, architecture_context, custom_instructions |


The optional `custom_instructions` variable is available to cluster and
overview prompts as well as leaf-page prompts. Use it for change-specific
evidence scope while retaining the prompt's response contract.
